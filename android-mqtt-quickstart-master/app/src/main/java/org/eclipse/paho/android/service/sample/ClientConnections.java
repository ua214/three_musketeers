 ...
 * 
 */
public class ClientConnections extends ListActivity implements LocationListener {
  public static String longitiude = null;
  ...
  public void onLocationChanged(Location location) {
    ...
    longitiude= String.valueOf(location.getLongitude());
